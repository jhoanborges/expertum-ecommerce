...
<div class="container text-center">
    <div class="row floating-footer-button">
        <div class="col-lg-12 ">
            <a class="btn btn-secondary button-rounded" href="{{ route('about_us') }}"><span class="white">Suscríbete</span>
            </a>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 footer_col">
                <div class="footer_column text-center centered">
                    <a class="logo_h " title="{{$param->nombre_tienda}}" href="{{route('welcome')}}">
                        <img src="//{{$param->logo}}" alt="" class="img-fluid logo-bar" />
                    </a>
                </div>
            </div>
            ...
            @endforeach
                        ...
                        {{--
                            ...
                            <div class="row text-center mt-3">
                                <div class="col-lg-12">
                                    <div class="footer_column">
                                        <div class="body-text mayus light-gray">©{{\Carbon\Carbon::now()->format('Y')}} - {{$param->nombre_tienda}}  - {{$param->razon_social}}</div>
                                    </div>
                                </div>
                            </div>
                            </p>
                            <div class="row text-center">
                                <div class="col-lg-12">
                                    <div class="footer_column">
                                        <div class="body-text ">
                                            <a href={{env('WEB_DEVELOPER')}} target="_blank" class="light-gray">Plataforma E-Commerce desarrollada por {{env('DEVELOPER_NAME')}}
                                            </a>
                                        </div>
                                    </div>
                                </div>
