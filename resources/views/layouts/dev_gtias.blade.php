...
<div class="container mb-3 border-bottom">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {{$param->razon_social}} te recomienda que cuando recibas el producto adquirido, ya sea en uno de nuestros almacenes o en tu domicilio, revises que este se encuentre en perfecto estado y que corresponda a la referencia adquirida. Antes de firmar el documento de entrega y aceptación, exige tu factura o soporte de la compra. No se aceptan reclamos por faltantes, daños o golpes después de recibida la mercancía.<br><br>
      ...
      Teléfono: {{$param->telefono}}<br>
      Correo electrónico: {{$param->correo}}<br>
      Formulario de contacto: <a href="{{ route('about_us') }}" target="_blank"> Clic Aquí </a><br><br>
      ...
      La garantía ofrecida por {{$param->razon_social}} será sobre productos adquiridos en nuestros puntos de venta o a través de nuestras tiendas en línea. Cualquier compra de productos a personas o empresas externas no será cubierta por nuestras políticas de garantías.<br><br>
