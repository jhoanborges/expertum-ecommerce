...
endif; ?>" name="name" value="<?php echo e(old('name')); ?>" required="name" autofocus>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="apellido" value="<?php echo e(old('apellido')); ?>" required="apellido" autofocus>
...
if (isset($messageCache)) { $message = $messageCache; }
                ...
                <div class="row">
                  <div class="col-sm-6 form-group">
                    ...
                    <?php if ($errors->has('tipo_identificacion')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('tipo_identificacion'); ?>
                    <span class="invalid-feedback" role="alert">
                    <strong><?php echo e($message); ?></strong>
                    </span>
                    <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                  ...
                  <div class="col-sm-6 form-group">
                    ...
                    <input id="numeroidentificacion" type="text" class="form-control <?php if ($errors->has('numeroidentificacion')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('numeroidentificacion'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="numeroidentificacion" value="<?php echo e(old('numeroidentificacion')); ?>" required="numeroidentificacion" onkeypress="return isNumberKey(event)">
                    <?php if ($errors->has('numeroidentificacion')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('numeroidentificacion'); ?>
                    <span class="invalid-feedback" role="alert">
                    <strong><?php echo e($message); ?></strong>
                    </span>
                    <?php unset($message);
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="direccion" value="<?php echo e(old('direccion')); ?>" required="direccion" autofocus>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="telefono" value="<?php echo e(old('telefono')); ?>" required="telefono" onkeypress="return isNumberKey(event)">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="email" value="<?php echo e(old('email')); ?>" required="email">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="password" required="new-password">
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\developerweb\ecommerce.developerweb.dev\resources\views/auth/register.blade.php ENDPATH**/ ?>