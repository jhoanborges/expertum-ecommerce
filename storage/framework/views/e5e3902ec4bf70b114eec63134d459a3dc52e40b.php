...
<div class="container mb-3 border-bottom">
  	...
  	<div class="row">
    	<div class="col-md-12">
    		...
    		<p>La siguiente política de devoluciones sólo se aplica a las compras realizadas en <?php echo e($param->nombre_tienda); ?><br><br>
			...
			<?php echo e($param->razon_social); ?> se reserva el derecho de aceptar los cambios, devoluciones o garantías con previo análisis del producto.<br><br> 
			CONDICIONES:<br> 
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\developerweb\ecommerce.developerweb.dev\resources\views/layouts/dev_cambios.blade.php ENDPATH**/ ?>