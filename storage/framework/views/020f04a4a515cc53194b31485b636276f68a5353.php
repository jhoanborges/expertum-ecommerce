                   ...
                   <?php if( $categorias->count() > 0 
                      ...
                      <div class="sidebar_section w-100" id="sidebar_section">
                        ...
                        <ul class="sidebar_categories list pmd-scrollbar mCustomScrollbar">
                            ...
                            <li>
                                <a class="category-name" href="<?php echo e(route('categoria.get', ['cat' => $cat2   , 'categoria' => $category->slug])); ?> "><?php echo e($category->nombrecategoria); ?></a>
                            </li>
...
<script>
    $(function(){
      $(".filters").change(function(e) {
        ...
        var url =
        '<?php echo e(route('categoria.get', ['cat' => $oldcat2 ,'categoria' => $idd,
        'filtros' =>':filtros',
...
<?php $__env->stopSection(); ?> 
<?php $__env->stopSection(); ?>
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\developerweb\ecommerce.developerweb.dev\resources\views/layouts/home.blade.php ENDPATH**/ ?>