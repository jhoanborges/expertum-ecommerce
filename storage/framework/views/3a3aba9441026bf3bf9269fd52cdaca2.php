                                    ...
                                    <ul class="footer_list d-inline-flex mt-2">
                                        <li>
                                            ...
                                            <a class="facebook-share-button"
                                                href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(route('product.show',
                                        ...
                                        <li>
                                            ...
                                            <a class="twitter-share-button"
                                                href="https://twitter.com/intent/tweet?text=<?php echo e($producto->nombre_producto); ?> <?php echo e(route('product.show', ['slug' => isset($producto->slug) ? $producto->slug : 'null'
                                                ])); ?>"
                                                data-size="large" data-text="<?php echo e($producto->nombre_producto); ?>"
                                                data-url="<?php echo e(route('product.show', ['slug' =>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\expertum-ecommerce\resources\views/layouts/product.blade.php ENDPATH**/ ?>