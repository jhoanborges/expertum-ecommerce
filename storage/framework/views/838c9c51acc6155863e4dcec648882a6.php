   ...
   rel="prev" aria-label="<?php echo app('translator')->get('pagination.previous'); ?>">
        <i class="fas fa-chevron-left"></i>
            ...
            <a class="page_prev d-flex flex-column align-items-center justify-content-center"
             href="<?php echo e($paginator->previousPageUrl()); ?>" rel="prev" aria-label="<?php echo app('translator')->get('pagination.previous'); ?>">
            ...
            <a class="page_next d-flex flex-column align-items-center justify-content-center" href="<?php echo e($paginator->nextPageUrl()); ?>" rel="next" aria-label="<?php echo app('translator')->get('pagination.next'); ?>">
...
<?php /**PATH C:\laragon\www\expertum-ecommerce\resources\views/vendor/pagination/bootstrap-4.blade.php ENDPATH**/ ?>