                  ...
                  <div class="col-sm-6">
                      ...
                      <div class="float-right row no-gutters right_side">
                          ...
                          <p class="mb-0 mr-2">
                              ...
                              <a href="https://wa.me/57<?php echo e($param->numerocontacto); ?>?text=Hola,%20estoy%20interesad@%20en%20tus%20productos.%20Me%20gustaría%20obtener%20más%20información%20acerca%20de:%20"
                                  target="_blank"
                                  class="black book ml-1 none-text body-text"><?php echo e($param->numerocontacto); ?></a>
                          </p>
                          ...
                          <li class="nav-item submenu dropdown">
                              <a href="#" class="nav-link" data-toggle="dropdown" role="button"
                                  aria-haspopup="true" aria-expanded="false"> <img src="<?php echo e(asset('img/account.png')); ?>"
                          ...
                          <a href="#" class="icons" id="cart">
                              <img src="<?php echo e(asset('img/cart.png')); ?>" class="img-fluid header-icon"><span
                                  class="counter"><?php echo e(Cart::instance('default')->content()->count() > 0? Cart::instance('default')->content()->count(): null); ?></span>
                          </a>
                                  ...
                                  <ul class="shopping-cart-items">
                                      <?php $__currentLoopData = Cart::instance('default')->content(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <li class="clearfix d-block">
                                              <a
                                                  href="<?php echo e(route('product.show', ['slug' => isset($product->slug) ? $product->slug : 'null'])); ?>">
                                                  <img src="<?php echo e($product->options->imagen); ?>" class="img-fluid"
                                                      alt="item1" />
                                                  ...
                                                  <?php if(isset($product->options->promocion->start) &&
                                                      ...
                                                      <div class="d-flex">
                                                          ...
                                                          <div class="ml-1">x <?php echo e($product->qty); ?></div>
                                                      </div>
                                                  <?php else: ?>
                                                  ...
                                                  <form action="<?php echo e(route('resumen.destroy', $product->rowId)); ?>"
                  ...
                  <div class="col-lg-4 top-brand">
                      <a class="logo_h" href="<?php echo e(route('home')); ?>">
                          ...
                          <a title="<?php echo e($param->nombre_tienda); ?>" href="<?php echo e(route('welcome')); ?>">
                              <img alt="<?php echo e($param->nombre_tienda); ?>" src="//<?php echo e($param->logo); ?>"
                  ...
                  <div class="col-lg-4 mx-auto search-bar">
                      ...
                      <form action="<?php echo e(route('store.search')); ?>" method="get" accept-charset="utf-8">
                          ...
                          <input type="text" name="search" id="search"
                              ...
                              value="<?php echo e(isset($search_key) ? $search_key : ''); ?>">
                      </form>
                      ...
                      <div class="row w-100 mr-0">
                          <div class="col-lg-12 pr-0">
                              <ul class="nav center-nav-bar p-4">
                                                          ...
                                                          <?php $__currentLoopData = $data->categories($allFilters); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                              <li class="nav-item">
                                                                  <a class="nav-link text-capitalize"
                                                                      href="<?php echo e(route('filter.search', $category->nombrecategoria )); ?>"
                                                                      class="no-decoration text-capitalize"><?php echo e($category->nombrecategoria); ?></a>
                                                              </li>
                                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                      </ul>
                                                  <?php endif; ?>
                                  ...
                                  <li
                                      class="nav-item <?php echo e(Route::currentRouteNamed('novedades.index') ? 'active' : ''); ?>">
                                      <a class="nav-link mayus" href="<?php echo e(route('novedades.index')); ?>">NOVEDADES</a>
                                  </li>

                                  <li
                                      class="nav-item <?php echo e(Route::currentRouteNamed('ofertas.index') ? 'active' : ''); ?>">
                                      <a class="nav-link mayus" href="<?php echo e(route('ofertas.index')); ?>">DESCUENTOS</a>
                                  </li>

                                  <?php if($param->show_featued_in_home == true): ?>
                                      <li
                                          class="nav-item <?php echo e(Route::currentRouteNamed('masvendidos.index') ? 'active' : ''); ?>">
