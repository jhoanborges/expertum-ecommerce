...
<?php $__currentLoopData = $top->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $to): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col-lg-12">
                ...
                <a href="<?php echo e(route('product.show' , ['product'=>$to['slug'] ])); ?>" class="d-flex pt-2 pb-2 border-bottom-custom">
...
<?php /**PATH C:\xampp\htdocs\developerweb\ecommerce.developerweb.dev\resources\views/partials/top.blade.php ENDPATH**/ ?>