...
if (isset($messageCache)) { $message = $messageCache; }
                    ...
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            ...
                            <input id="state-1" type="text" class="form-control <?php if ($errors->has('state-1')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('state-1'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>"
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input id="state-2" type="text" class="form-control <?php if ($errors->has('state-2')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('state-2'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>"
                    ...
                    -->
                            <?php if ($errors->has('stte-2')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('stte-2'); ?>
                                <span class="invalid-feedback" role="alert">
                                    <strong><?php echo e($message); ?></strong>
                                </span>
                            <?php unset($message);
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input id="telfacturacion" type="text"
                                class="form-control <?php if ($errors->has('telfacturacion')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('telfacturacion'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="telfacturacion"
                                value="<?php echo e($telfacturacion); ?>" required readonly=""
                                onkeypress="return isNumberKey(event)">

                            <?php if ($errors->has('telfacturacion')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('telfacturacion'); ?>
                                <span class="invalid-feedback" role="alert">
                                    <strong><?php echo e($message); ?></strong>
                                </span>
                            <?php unset($message);
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input id="telefono" type="text"
                                class="form-control <?php if ($errors->has('telefono')) :
if (isset($message)) { $messageCache = $message; }
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="col-sm-12 form-group">
                            ...
                            <textarea rows="2" input id="observaciones" type="text"
                                class="form-control <?php if ($errors->has('observaciones')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('observaciones'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="observaciones"
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\developerweb\ecommerce.developerweb.dev\resources\views/layouts/checkout.blade.php ENDPATH**/ ?>