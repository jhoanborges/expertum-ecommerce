...
<?php $__currentLoopData = $categoriasBoot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="nav-item">
                          <a class="nav-link text-capitalize" href="<?php echo e(route('categoria.get', ['cat' => ($cat2 ?? 1)   , 'categoria' => $category->slug])); ?> "><?php echo e($category->nombrecategoria); ?></a>
                        </li>
             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </ul>
                    </li>
...
<?php endif; ?>
          ...
          <!--================Header Menu Area =================-->
          <?php /**PATH C:\xampp\htdocs\developerweb\ecommerce.developerweb.dev\resources\views/partials/navbar.blade.php ENDPATH**/ ?>